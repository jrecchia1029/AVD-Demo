...
| --------- | --------------- | ------------ | --------- |
| MLAG | Vlan4094 | 192.168.254.9 | Port-Channel49 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_NoLa-Leaf-3B_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_NoLa-Leaf-3B_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet51 | L2_NoLa-Spine-1_Ethernet4 | *trunk | *4092 | *- | *- | 51 |
| Ethernet52 | L2_NoLa-Spine-2_Ethernet4 | *trunk | *4092 | *- | *- | 51 |
| Ethernet53 | L2_NoLa-Leaf-3C_Ethernet25 | *trunk | *11-12,21-22,3401-3402,4092 | *- | *- | 53 |
| Ethernet54 | L2_NoLa-Leaf-3D_Ethernet25 | *trunk | *11-12,21-22,3401-3402,4092 | *- | *- | 54 |
| Ethernet55 | L2_NoLa-Leaf-3E_Ethernet25 | *trunk | *11-12,21-22,3401-3402,4092 | *- | *- | 55 |
...
interface Ethernet49
   description MLAG_NoLa-Leaf-3B_Ethernet49
   no shutdown
...
interface Ethernet50
   description MLAG_NoLa-Leaf-3B_Ethernet50
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet51
   description L2_NoLa-Spine-1_Ethernet4
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_NoLa-Spine-2_Ethernet4
   no shutdown
   channel-group 51 mode active
!
interface Ethernet53
   description L2_NoLa-Leaf-3C_Ethernet25
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet54
   description L2_NoLa-Leaf-3D_Ethernet25
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet55
   description L2_NoLa-Leaf-3E_Ethernet25
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_NoLa-Leaf-3B_Port-Channel49 | trunk | - | - | MLAG | 30 | individual | - | - |
...
interface Port-Channel49
   description MLAG_NoLa-Leaf-3B_Port-Channel49
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4092 |  default  |  10.40.92.8/24  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.254.8/31  |  -  |  -  |  -  |  -  |
