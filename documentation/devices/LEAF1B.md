...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | SERVER_dc1-leaf1-server1_PCI2 | *trunk | *11-13,21-22 | *4092 | *- | 5 |
| Ethernet6 | SERVER_phones_PCI2 | trunk phone | - | 201 | - | - |
| Ethernet49 | MLAG_LEAF1A_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_LEAF1A_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet53 | L2_LEAF1C_Ethernet52 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 53 |
| Ethernet54 | L2_LEAF1D_Ethernet52 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 54 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51 | P2P_SPINE1_Ethernet2 | - | 172.16.200.5/31 | default | 1500 | False | - | - |
| Ethernet52 | P2P_SPINE2_Ethernet2 | - | 172.16.200.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet6
   description SERVER_phones_PCI2
   no shutdown
...
interface Ethernet49
   description MLAG_LEAF1A_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_LEAF1A_Ethernet50
   no shutdown
   channel-group 49 mode active
!
...
interface Ethernet53
   description L2_LEAF1C_Ethernet52
   no shutdown
   channel-group 53 mode active
!
interface Ethernet54
   description L2_LEAF1D_Ethernet52
   no shutdown
...
| Port-Channel49 | MLAG_LEAF1A_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_LEAF1A_Port-Channel49
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 172.16.0.4/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 172.16.200.4 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.200.6 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 192.168.254.128 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.168.254.128 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 172.16.0.4:10011 | 10011:10011 | - | - | learned |
| 12 | 172.16.0.4:10012 | 10012:10012 | - | - | learned |
| 21 | 172.16.0.4:10021 | 10021:10021 | - | - | learned |
| 22 | 172.16.0.4:10022 | 10022:10022 | - | - | learned |
| 3401 | 172.16.0.4:13401 | 13401:13401 | - | - | learned |
| 3402 | 172.16.0.4:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF10 | 172.16.0.4:10 | connected |
| VRF11 | 172.16.0.4:11 | connected |
...
router bgp 65001
   ...
   neighbor 192.168.254.128 description LEAF1A_Vlan4093
   ...
   vrf VRF10
      ...
      update wait-install
      neighbor 192.168.254.128 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.168.254.128 description LEAF1A_Vlan3009
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 192.168.254.128 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.168.254.128 description LEAF1A_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
