...
| --------- | --------------- | ------------ | --------- |
| MLAG | Vlan4094 | 192.168.254.4 | Port-Channel49 |
...
| Ethernet53 | LEAF2C_Ethernet52 | *trunk | *11-14,21-22,3401-3402 | *- | *- | 53 |
| Ethernet54 | LEAF2D_Ethernet52 | *trunk | *11-14,21-22,3401-3402 | *- | *- | 54 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51 | P2P_LINK_TO_SPINE1_Ethernet4 | routed | - | 172.16.200.13/31 | default | 1500 | False | - | - |
| Ethernet52 | P2P_LINK_TO_SPINE2_Ethernet4 | routed | - | 172.16.200.15/31 | default | 1500 | False | - | - |
...
interface Ethernet50
   description MLAG_PEER_LEAF2A_Ethernet50
   no shutdown
   channel-group 49 mode active
!
...
interface Ethernet53
   description LEAF2C_Ethernet52
   no shutdown
   channel-group 53 mode active
!
interface Ethernet54
   description LEAF2D_Ethernet52
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.0.6/32 |
...
| Vlan3010 |  VRF11  |  192.168.254.133/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.254.133/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.254.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 172.16.200.12 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.200.14 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 192.168.254.132 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.168.254.132 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.168.254.132 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 14 | 172.16.0.6:10014 | 10014:10014 | - | - | learned |
| 21 | 172.16.0.6:10021 | 10021:10021 | - | - | learned |
| 22 | 172.16.0.6:10022 | 10022:10022 | - | - | learned |
| 3401 | 172.16.0.6:13401 | 13401:13401 | - | - | learned |
| 3402 | 172.16.0.6:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF10 | 172.16.0.6:10 | connected |
| VRF11 | 172.16.0.6:11 | connected |
...
router bgp 65002
   ...
   neighbor 192.168.254.132 description LEAF2A
