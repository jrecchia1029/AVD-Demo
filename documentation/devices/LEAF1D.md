...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet51 | L2_LEAF1A_Ethernet54 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 51 |
| Ethernet52 | L2_LEAF1B_Ethernet54 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 51 |
...
interface Ethernet51
   description L2_LEAF1A_Ethernet54
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_LEAF1B_Ethernet54
   no shutdown
   channel-group 51 mode active
```
